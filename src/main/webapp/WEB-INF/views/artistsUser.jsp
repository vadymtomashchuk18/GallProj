				...
				<div class="modal-body">
					...
					<form action="searchArtistName" method="POST" role="form">
						...
						<div class="form-group">
							<label for="lastName">Artist name</label> <input type="text"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Search artists by
						movement name</h4>
				</div>
				<div class="modal-body">
					<form action="searchArtistMovementName" method="POST" role="form">
